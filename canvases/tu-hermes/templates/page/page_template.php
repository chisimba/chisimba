...
if (!isset($suppressFooter)) {
    ...
    if (isset($footerStr)) {
       $footerStr = $footerStr;
        ...
        $footerStr = "<h3>With the Payment Pebble API, now you can make things easy too!<br />Visit our <a href='http://developer.thumbzup.com'>API developer site</a> to find out more</h3>";
    }
