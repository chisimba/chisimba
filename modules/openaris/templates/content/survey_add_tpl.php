<?php
/**
 * ahis survey add Template
 *
 * Template to add survey
 * 
 * PHP version 5
 * 
...
$sButton->setToSubmit();
$backUri = $this->uri(array('action'=>'survey_admin'));
...
$objTable->startRow();
$objTable->addCell($this->objLanguage->languageText('word_survey').": ");
...
$objForm = new form('surveyadd', $formUri);
$objForm->addToForm($objTable->show());
$errorMsg = str_replace('name', $this->objLanguage->languageText('word_survey'), $this->objLanguage->languageText('mod_ahis_namerequired', 'openaris'));
