<?php
/**
 * ahis Add Species Names
 *
 * File containing the Add Species Names template
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: species_names_tpl.php 
...
$formAction = 'species_names_save';  
$buttonText = 'Save';

$speciesDrop = new dropdown('species');
$speciesDrop->addOption('','select');
$speciesDrop->addFromDB($species, 'speciesname', 'id');
...
$common_name= new textinput('common_name',$common_name);
...
$form->addRule('species', 'Please select species', 'required');
...
//buttons
$button = new button ('species_names_save', 'Save');
$button->setCSS('saveButton');
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'species_names_admin'));
