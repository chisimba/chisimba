<?php
/**
 * ahis Edit Other COntrol Measures
 *
 * File containing the Edit Other Control Measures template
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: edit_other_control_measures_tpl.php 
...
$formAction = 'other_control_measures_update';  
$buttonText = 'Save';
...
$code= new textinput('code',$measures['0']['control_measure_code']);
...
$measure= new textinput('measure',$measures['0']['control_measure']);
$label = new label ('Control Measure:', 'measure');
$formTable->startRow();
$formTable->addCell($label->show());
$formTable->addCell($measure->show());
$formTable->endRow();

	
$label = new label ('Abbreviation:', 'abbrev');
$abbrev=new textinput('abbrev',$measures['0']['abbreviation']);
$formTable->startRow();
$formTable->addCell($label->show());
...
$remarksBox = new textarea('desc', $measures['0']['description'], 4, 40);
...
$form->addRule('code', 'Please enter code', 'required');
$form->addRule('measure', 'Please enter contol measure', 'required');
$form->addRule('abbrev', 'Please enter Abbreviation', 'required');
$form->addRule('desc', 'Please enter Description', 'required');

//buttons
$button = new button ('other_control_measures_update', 'Save');
