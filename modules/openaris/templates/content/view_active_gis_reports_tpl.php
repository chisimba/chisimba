 ...
 * @version   $Id: view_active_gis_reports_tpl.php 13696 2009-06-18 14:00:08Z nic $
...
function doPoint(point) {
		...
		google.earth.addEventListener(placemark, "mouseover", function(event) {
		  ...
		  "<table>" +
		  "<tr><td>Campaign Name:</td><td>" + dataJSONObject.results[point].refno + "</td></tr>" +
		  ...
		  "<tr><td>Survey Type:</td><td>" + dataJSONObject.results[point].surveytype + "</td></tr>" +
		  "<tr><td>Test Date:</td><td>" + dataJSONObject.results[point].testdate + "</td></tr>" +
		  "<tr><td>Animal:</td><td>" + dataJSONObject.results[point].animal + "</td></tr>" +
		  "<tr><td>Age:</td><td>" + dataJSONObject.results[point].age + "</td></tr>" +
		  "<tr><td>Sex:</td><td>" + dataJSONObject.results[point].sex + "</td></tr>" +
		  "<tr><td>Number:</td><td>" + dataJSONObject.results[point].number + "</td></tr>" +
		  "<tr><td>Disease:</td><td>" + dataJSONObject.results[point].diseasetype + "</td></tr>" +
		  "<tr><td>Farm:</td><td>" + dataJSONObject.results[point].farm + "</td></tr>" +
		  "<tr><td>Farming System:</td><td>" + dataJSONObject.results[point].farmingsystem + "</td></tr>" +
		  "<tr><td>Sample Type:</td><td>" + dataJSONObject.results[point].sampletype + "</td></tr>" +
		  "<tr><td>Test Type:</td><td>" + dataJSONObject.results[point].testtype + "</td></tr>" +
		  "<tr><td>Test Result:</td><td>" + dataJSONObject.results[point].testresult + "</td></tr>" +
		  "</table>");
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=978
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:13.6pt'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'>Active
...
<div id="map3d_container" style="border: 1px solid silver; height: 450px; width: 600px;">  <div id="map3d" style="height: 100%;"></div></div>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="javascript:" onclick="submitQuery();" id='btnSubmit' style="display:inline"><img src="<?php echo "$imageFolder/createmap.jpg"?>" alt="CREATE MAP" title="CREATE MAP" /></a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="<?php echo $this->uri(array('action'=>'view_reports')); ?>" id='btnCancel' style="display:inline"><img src="<?php echo "$imageFolder/cancel.jpg"?>" alt="CANCEL" title="CANCEL" /></a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="javascript:" id='btnBack' onclick="window.location.reload();" style="display:none"><img src="<?php echo "$imageFolder/backviewreports.jpg"?>" alt="BACK TO VIEW REPORTS" title="BACK TO VIEW REPORTS" /></a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="<?php echo $this->uri(array('action'=>'gis_reports', 'report'=>1)); ?>" id='btnNew' style="display:none"><img src="<?php echo "$imageFolder/newgismap.jpg"?>" alt="NEW GIS MAP" title="NEWGISMAP" /></a></b></p>
  </td>
 </tr>
</table>
