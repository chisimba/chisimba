...
$isolanguagecode= new textinput('isolanguagecode',$code);
...
$language = new textinput('language',$lang);
$formTable->startRow();
$formTable->addCell($label->show());
...
//buttons
$button = new button ('language_save', 'Save');
$button->setCSS('saveButton');
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'language_admin'));
