<?php
/**
 * ahis exchange rate details Admin Template
 *
 *
 * PHP version 5
 * 
 ...
 * @version   $Id: ahis_exchangeratedetailsadmin_tpl.php 12233
...
$addLink = new link($this->uri(array('action'=>'exchangeratedetails_add')));
$addLink->link = 'Add exchange rate details';

$objHeading = $this->getObject('htmlheading','htmlelements');
$objHeading->type = 2;
$objHeading->str = 'Exchange rate details admin';
...
$button->setToSubmit();
$uri = $this->uri(array('action'=>'exchangeratedetails_admin'));
...
$objTable->addHeaderCell('Conversion factor');
...
if (!empty($data)) {
    foreach ($data as $datum) {
        ...
        $objTable->addCell($datum['exchangerateid']);
        $objTable->addCell($datum['conversionfactor']);
