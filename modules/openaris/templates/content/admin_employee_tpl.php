<?php
/**
 * ahis Employee Admin Template
 *
 * employee admin overview template
 *
 * PHP version 5
 * 
 ...
 * @version   $Id: admin_employee_tpl.php 13708 2009-06-19 15:11:27Z nic $
...
$objHeading->type = 2;
$objHeading->str = $this->objLanguage->languageText('mod_ahis_employeeadmin','openaris');
...
$uri = $this->uri(array('action'=>'employee_admin'));
...
$objTable->addHeaderCell($this->objLanguage->languageText('word_surname'));
$objTable->addHeaderCell($this->objLanguage->languageText('word_name'));
$objTable->addHeaderCell($this->objLanguage->languageText('word_username'));
$objTable->addHeaderCell($this->objLanguage->languageText('word_status'));
