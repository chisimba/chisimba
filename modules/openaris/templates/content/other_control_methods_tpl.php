<?php
/**
 * ahis Add Other COntrol Measures
 *
 * File containing the Add Other Control Measures template
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: other_control_measures_tpl.php 
...
$formAction = 'other_control_measures_save';  
$buttonText = 'Save';
...
$measure= new textinput('measure',$measure);
...
//buttons
$button = new button ('other_control_measures_save', 'Save');
$button->setCSS('saveButton');
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'other_control_measures_admin'));
