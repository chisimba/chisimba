...
$formAction = 'diagnostic_method_save';  
$buttonText = 'Save';
...
$diagnostic_method= new textinput('diagnostic_method',$method);
...
//buttons
$button = new button ('diagnostic_method_save', 'Save');
$button->setCSS('saveButton');
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'diagnostic_method_admin'));
