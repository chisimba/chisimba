<?php
/**
 * ahis disease species  Admin Template
 *
 *
 * PHP version 5
 * 
 ...
 * @version   $Id: ahis_diseasespecies_tpl.php 12233 2009-10-02 10:57:26Z nic $
...
$addLink = new link($this->uri(array('action'=>'diseasespecies_add')));
$addLink->link = 'New disease species add';

$objHeading = $this->getObject('htmlheading','htmlelements');
$objHeading->type = 2;
$objHeading->str = 'Disease species admin';
...
$button->setToSubmit();
$uri = $this->uri(array('action'=>'newdiseasespecies_admin'));
...
$objTable->addHeaderCell($this->objLanguage->languageText('phrase_diseasespecies'));
...
if (!empty($data)) {
    foreach ($data as $datum) {
        ...
        $objTable->addCell($datum['speciesid']);
