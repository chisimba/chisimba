<?php
/**
 * ahis vaccination add Template
 *
 * Template to add vaccination
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: vaccination_add_tpl.php 
...
$sButton->setToSubmit();
$backUri = $this->uri(array('action'=>'vaccinationhistory_admin'));
...
$objForm = new form('vaccinationadd', $formUri);
$objForm->addToForm($objTable->show());
$errorMsg = str_replace('name', $this->objLanguage->languageText('phrase_vaccinationhistory'), $this->objLanguage->languageText('mod_ahis_namerequired', 'openaris'));
