<?php
/**
 * ahis test add Template
 *
 * Template to add test
 * 
 * PHP version 5
 * 
...
$sButton->setToSubmit();
$backUri = $this->uri(array('action'=>'test_admin'));
...
$objTable->startRow();
$objTable->addCell($this->objLanguage->languageText('word_test').": ");
...
$objForm = new form('testadd', $formUri);
$objForm->addToForm($objTable->show());
$errorMsg = str_replace('name', $this->objLanguage->languageText('word_test'), $this->objLanguage->languageText('mod_ahis_namerequired', 'openaris'));
