<?php
/**
 * ahis farmingsystem add Template
 *
 * Template to add farmingsystem
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: farmingsystem_add_tpl.php 
...
$sButton->setToSubmit();
$backUri = $this->uri(array('action'=>'farmingsystem_admin'));
...
$errorMsg = str_replace('name', $farming_system, $this->objLanguage->languageText('mod_ahis_namerequired', 'openaris'));
