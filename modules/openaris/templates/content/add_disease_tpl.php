 ...
 * ahis Add Disease
 *
 * File containing the Add Disease template
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: add_disease_tpl.php 
...
$shortname= new textinput('shortname',$shortname);
//$isolanguagecode->extra='readonly';
...
$ref_code = new textinput('ref_code',$refcode);
$formTable->startRow();
$formTable->addCell($label->show());
...
$form->addRule('in_oie_list', 'Is disease in OIE list?', 'required');



//buttons
$button = new button ('disease_save', 'Save');
$button->setCSS('saveButton');
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'diseases_admin'));
