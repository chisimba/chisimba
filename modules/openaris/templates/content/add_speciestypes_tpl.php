...
if ($id) {
    ...
    $hStr = $this->objLanguage->languageText('word_add')." ".$this->objLanguage->languageText('mod_ahis_speciestyps','openaris');
...
$backUri = $this->uri(array('action'=>'speciestype_view'));
...
$objTable->addCell($speciestype->show());
$objTable->endRow();
...
//form validations
$objForm->addRule('speciestype', $this->objLanguage->languageText('mod_ahis_speciestypeerror','openaris'),'required');
