<?php
/**
 * ahis Geography level 3 add Template
 *
 * Template to add Geography Segment Level 3
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: geo3_add_tpl.php 13717 2009-06-22 08:16:22Z nic $
...
if ($id) {
    ...
    $hStr = $this->objLanguage->languageText('mod_ahis_geo3add','openaris');
...
$sButton->setToSubmit();
$backUri = $this->uri(array('action'=>'geography_level3_admin'));
