<?php
/**
 * ahis Infection sources Admin Template
 *
 *
 * PHP version 5
 * 
...
$addLink = new link($this->uri(array('action'=>'infectionsources_add')));
$addLink->link = 'Infection sources add';

$objHeading = $this->getObject('htmlheading','htmlelements');
$objHeading->type = 2;
$objHeading->str = 'Infection sources admin';
...
$button->setToSubmit();
$uri = $this->uri(array('action'=>'infectionsources_admin'));
...
$objTable->addHeaderCell($this->objLanguage->languageText('phrase_possiblesource'));
...
if (!empty($data)) {
    foreach ($data as $datum) {
        ...
        $objTable->addCell($datum['possiblesource']);
