...
$objHeading->type = 2;
$objHeading->str = $parentname."    ".$headingText;
...
$objTable->addHeaderCell("Partition Code");
$objTable->addHeaderCell("Partition Name");
$objTable->addHeaderCell("Partition Level");
$objTable->addHeaderCell("Partition Code");
...
if (!empty($data)) {
	...
	$slink->link = $datum["partitionname"];
	$objTable->addCell($slink->show());	
	$objTable->addCell($dt[0]["partitionlevel"]);
	$objTable->addCell($datum["partitioncode"]);
