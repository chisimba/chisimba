<?php
	...
	//title
	$title = $this->objLanguage->languageText('mod_ahis_controlmeasurestitle', 'openaris', 'Control Measures');
...
$formTable->endRow();
	...
	$formAction = 'controlmeasures_save';  
    $buttonText = 'Save';
