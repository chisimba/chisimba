<?php
/**
 * ahis Agent Admin Template
 *
 * agent admin overview template
 *
 * PHP version 5
 * 
 ...
 * @version   $Id: ahis_agentsadmin_tpl.php 12233 2009-10-10 10:57:26Z isaac $
...
$addLink = new link($this->uri(array('action'=>'agents_add')));
$addLink->link = 'New agent add';

$objHeading = $this->getObject('htmlheading','htmlelements');
$objHeading->type = 2;
$objHeading->str = 'Agents admin';
...
$button->setToSubmit();
$uri = $this->uri(array('action'=>'newagent_admin'));
...
$objTable->addHeaderCell($this->objLanguage->languageText('phrase_agent'));
...
if (!empty($data)) {
    foreach ($data as $datum) {
        ...
        $objTable->addCell($datum['agentcode']);
	    $objTable->addCell($datum['agent']);
