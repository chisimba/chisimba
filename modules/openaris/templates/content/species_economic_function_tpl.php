<?php
/**
 * ahis Add Species Economic Function
 *
 * File containing the Add Species Economic Function template
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: species_economic_function_tpl.php 
...
$formAction = 'species_economic_function_save';  
$buttonText = 'Save';
...
$economic_function= new textinput('economic_function',$economic_function);
...
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'species_economic_function_admin'));
