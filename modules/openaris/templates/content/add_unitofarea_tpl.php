<?php
/**
 * ahis Add Unit Of Area
 *
 * File containing the Add Units Of Area template
 * 
 * PHP version 5
 * 
 ...
 * @version   $Id: add_unitOfArea_tpl.php 
...
$unit_of_area= new textinput('unit_of_area',$unit_of_area);
...
$button->setToSubmit();
$backUri = $this->uri(array('action'=>'unit_of_area_admin'));
