...
$objTable->addHeaderCell($columnName1);
$objTable->addHeaderCell($columnName2);
$objTable->addHeaderCell($columnName3);
$objTable->addHeaderCell($columnName4);
$objTable->addHeaderCell($columnName5);
$objTable->addHeaderCell($columnName6);
...
if (!empty($data)) {
    foreach ($data as $datum) {
        ...
        $objTable->addCell($datum[$fieldName1]);
        $objTable->addCell($datum[$fieldName2]);
        $objTable->addCell($datum[$fieldName3]);
        $objTable->addCell($this->objUser->fullName($datum[$fieldName4]));
        $objTable->addCell($datum[$fieldName5]);
        $objTable->addCell($this->objUser->fullName($datum[$fieldName6]));
