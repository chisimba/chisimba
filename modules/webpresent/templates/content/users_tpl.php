<?php 
    ...
    if($searchField=='listall'){
        $pgTitle->str ='Add as Participant';
    } else {
        $pgTitle->str ='Add as Participant'."&nbsp;"./*'-'."&nbsp;".$objLanguage->languageText('mod_buddies_letter')."&nbsp;".*/ '"' . $searchField . '"' ;
    }
    ...
    $objBackLink->link($this->uri(array('module' => 'webpresent')));
    $objBackLink->link = 'Return to Webpresent';
