<?
/*
* Template to display the lecturers comment on an practical.
* @package practical
*/

/**
* @param array $data Array contains the practical name and comments.
*/
...
$head = $this->objLanguage->languageText('mod_practicals_comment');
