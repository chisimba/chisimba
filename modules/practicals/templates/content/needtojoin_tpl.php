...
$header->str = $this->objLanguage->code2Txt('mod_practicals_unabletoentercontext', 'practicals', NULL, 'Unable to go practicalss');
$content=="";
$content.= $header->show();

$content.= '<p>'.$this->objLanguage->code2Txt('mod_practicals_unabletoenterinfo', 'practicals', NULL, 'It appears you have not joined the course, or been logged out of the course.').'</p>';
