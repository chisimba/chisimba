...
class kngimport extends controller 
{
   /*
    ...
    */
    ...
    public function init()
    {
        ...
        $this->_objUtils = $this->getObject('utils', 'kngimport');
        $this->_objDBContextParams = $this->getObject('dbcontextparams', 'context');
    	// Load Import IMS class.
    	$this->objImportIMSContent = $this->newObject('importimspackage','kngimport');
    	// Load Import KNG class.
    	$this->objImportKNGContent = $this->newObject('importkngpackage','kngimport');
    	// Load Export IMS class.
    	$this->objExportIMSContent = $this->newObject('exportimspackage','kngimport');
