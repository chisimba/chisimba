...
{
	/**
	 * @var genreflectionClass[] Array with available classes
	 */
	public $classes = array();

	/**
	 * @var genreflectionclass The current class
	 */
	public $class = "";
	...
	*/
	...
	{
		$this->class = new genreflectionclass($class);
	}
	/**
	 *
	 *
	 * @return genreflectionclass[]
	 */
	function getClasses()
	{
		...
		foreach($ar as $class){
			...
			{//add only when class is user-defined
				$this->classes[$class] = new genreflectionclass($class);
			}
		}
		ksort($this->classes);
		return $this->classes;
