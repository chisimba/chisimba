...
$header->str = $this->objLanguage->code2Txt('mod_assignment_unabletoentercontext', 'assignment', NULL, 'Unable to go assignments');
$content=="";
$content.= $header->show();

$content.= '<p>'.$this->objLanguage->code2Txt('mod_assignment_unabletoenterinfo', 'assignment', NULL, 'It appears you have not joined the course, or been logged out of the course.').'</p>';
