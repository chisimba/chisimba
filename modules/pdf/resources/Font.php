...
require_once 'FileParserDataSource.php';

/** Zend_Pdf_FileParserDataSource_File */
require_once 'FileParserDataSource/File.php';

/** Zend_Pdf_FileParserDataSource_String */
require_once 'FileParserDataSource/String.php';

/** Zend_Pdf_FileParser_Font_OpenType_TrueType */
require_once 'FileParser/Font/OpenType/TrueType.php';

/** Zend_Pdf_Resource_Font_OpenType_TrueType */
require_once 'Resource/Font/OpenType/TrueType.php';

/** Zend_Pdf_Resource_Font_Standard_Courier */
require_once 'Resource/Font/Standard/Courier.php';

/** Zend_Pdf_Resource_Font_Standard_CourierBold */
require_once 'Resource/Font/Standard/CourierBold.php';

/** Zend_Pdf_Resource_Font_Standard_CourierBoldOblique */
require_once 'Resource/Font/Standard/CourierBoldOblique.php';

/** Zend_Pdf_Resource_Font_Standard_CourierOblique */
require_once 'Resource/Font/Standard/CourierOblique.php';

/** Zend_Pdf_Resource_Font_Standard_Helvetica */
require_once 'Resource/Font/Standard/Helvetica.php';

/** Zend_Pdf_Resource_Font_Standard_HelveticaBold */
require_once 'Resource/Font/Standard/HelveticaBold.php';

/** Zend_Pdf_Resource_Font_Standard_HelveticaBoldOblique */
require_once 'Resource/Font/Standard/HelveticaBoldOblique.php';

/** Zend_Pdf_Resource_Font_Standard_HelveticaOblique */
require_once 'Resource/Font/Standard/HelveticaOblique.php';

/** Zend_Pdf_Resource_Font_Standard_Symbol */
require_once 'Resource/Font/Standard/Symbol.php';

/** Zend_Pdf_Resource_Font_Standard_TimesBold */
require_once 'Resource/Font/Standard/TimesBold.php';

/** Zend_Pdf_Resource_Font_Standard_TimesBoldItalic */
require_once 'Resource/Font/Standard/TimesBoldItalic.php';

/** Zend_Pdf_Resource_Font_Standard_TimesItalic */
require_once 'Resource/Font/Standard/TimesItalic.php';

/** Zend_Pdf_Resource_Font_Standard_TimesRoman */
require_once 'Resource/Font/Standard/TimesRoman.php';

/** Zend_Pdf_Resource_Font_Standard_ZapfDingbats */
require_once 'Resource/Font/Standard/ZapfDingbats.php';
