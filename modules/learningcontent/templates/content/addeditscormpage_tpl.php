...
if ($mode == 'edit') {
    ...
    echo '<h1>'.$this->objLanguage->languageText('mod_learningcontent_editcontextpages','learningcontent').': - '.$page['pagetitle'].'</h1>';
} else {
    echo '<h1>'.$this->objLanguage->languageText('mod_learningcontent_addnewcontextpages','learningcontent').' - '.$this->objContext->getTitle().'</h1>';
...
$button = new button('submitbutton', $this->objLanguage->languageText('mod_learningcontent_addcontextpages','learningcontent'));
