...
Ext.MessageBox.confirm('Delete Essay?', 'Are you sure you want to delete this essay?', function(btn){

  if (btn == 'yes') {
    window.location.href='?module=jukskei&action=deleteessay'+'&tessayid='+essayid;
  }
...
var grid = new xg.GridPanel({
    ...
    columns: [
        ...
        {header: "Details", width: 100, dataIndex: 'details'},
...
function showSessionDetails(detailsdata){
