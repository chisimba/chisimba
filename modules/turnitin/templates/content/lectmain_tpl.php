...
//do the check to check if TII is accessable
	...
	*/
	...
	a.blue:link, a.blue:visited	{ font-size: 10px; font-family: Lucida Grande, Lucida Sans Unicode; background: blue; padding: 0 12px 0 0; text-decoration: none; color: #000; border: 1px solid #888; display: block; text-align: left; width: 38px; cursor: pointer;}
