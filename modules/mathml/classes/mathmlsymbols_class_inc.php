 ...
 * Class to parse mathematical expressions into MathML

 * @author Paul Scott

 * Based on a script by  Kee-Lin Steven Chan (kc56@cornell.edu)

 * @package mathml

 * @copyright GNU/GPL 2005

 */



class mathmlsymbols /*extends object */

{
	...
	/**
 	 ...
 	 * method to return an array of symbols to be used in the mathML Classes

 	 * @param void

 	 * @return array symbol_arr
...

	{
		...
		'gcd'	=> array( 'input'=>'gcd', 'tag'=>'mo', 'output'=>'gcd'),

		'lcm'	=> array( 'input'=>'lcm', 'tag'=>'mo', 'output'=>'lcm'),

		'lub'	=> array( 'input'=>'lub', 'tag'=>'mo', 'output'=>'lub'), /* 2005-06-11 wes */

		'glb'	=> array( 'input'=>'glb', 'tag'=>'mo', 'output'=>'glb'), /* 2005-06-11 wes */

		'min'	=> array( 'input'=>'min', 'tag'=>'mo', 'output'=>'min'), /* 2005-06-11 wes */

		'max'	=> array( 'input'=>'max', 'tag'=>'mo', 'output'=>'max'), /* 2005-06-11 wes */
