...
echo '<h1>'.$this->objLanguage->languageText('mod_hotels_editmenuitem', 'hotels', 'Edit Menu Item').': '.$item['itemvalue'].'</h1>';

$button = new button ('adddividerbutton', $this->objLanguage->languageText('mod_hotels_updatetext', 'hotels', 'Update Text'));
$button->setToSubmit();
