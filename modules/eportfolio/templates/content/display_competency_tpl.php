...
$objHeading->str = $ownersurname . $objLanguage->languageText("mod_eportfolio_es", 'eportfolio') . ' ' . $objLanguage->languageText("mod_eportfolio_wordCompetency", 'eportfolio');
...
$objTable->addCell($objWashout->parseText($competency_type) , null, "top", "left", null, null, null);
$objTable->endRow();
//display award date
// Spacer
$objTable->startRow();
...
// display user's names
$objTable->startRow();
$objTable->addCell($objWashout->parseText("<b>" . $label = $objLanguage->languageText("mod_eportfolio_qclawarddate", 'eportfolio') . ":</b>") , null, "top", "right", null, null, null);
$objTable->addCell($objWashout->parseText($this->objDate->formatDate($award_date)) , null, "top", "left", null, null, null);
$objTable->endRow();
