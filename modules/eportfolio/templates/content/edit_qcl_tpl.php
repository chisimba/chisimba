...
$objHeading->type = 1;
$objHeading->str = $objLanguage->languageText("mod_eportfolio_editqcl", 'eportfolio');
echo $objHeading->show();
$form = new form("add", $this->uri(array(
    'module' => 'eportfolio',
    'action' => 'editqclconfirm',
    'id' => $id
)));
...
if (!empty($categorytypeList)) {
    foreach($categorytypeList as $categories) {
        ...
        $mydropdown->setSelected($qcl_type);
    }
} else {
...
$textinput = new textinput("qcl_level", $qcl_level);
$textinput->size = 40;
