...
$objHeading->str = $ownersurname . $objLanguage->languageText("mod_eportfolio_assertionDisplay", 'eportfolio');
...
// display user's names
$objTable->startRow();
$objTable->addCell($objWashout->parseText("<b>" . $label = $objLanguage->languageText("mod_eportfolio_lecturer", 'eportfolio') . ":</b>") , null, "top", "right", null, null, null);
