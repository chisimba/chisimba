...
$pdf->TextField('firstname', 50, 5, array(
    'strokeColor' => 'ltGray'
));
$pdf->Ln(6);
//Last name
$pdf->Cell(35, 5, 'Last name:');
$pdf->TextField('lastname', 50, 5, array(
    'strokeColor' => 'ltGray'
));
$pdf->Ln(6);
//Gender
$pdf->Cell(35, 5, 'Gender:');
$pdf->ComboBox('gender', 10, 5, array(
    '',
    'M',
    'F'
) , array(
...
//Gender
$pdf->Cell(35, 5, 'List:');
$pdf->ListBox('listbox', 60, 15, array(
    '',
    'item1',
    'item2',
    'item3',
...
$pdf->TextField('address', 60, 18, array(
    'multiline' => true,
    'strokeColor' => 'ltGray'
));
$pdf->Ln(19);
...
$pdf->TextField('email', 50, 5, array(
    'strokeColor' => 'ltGray'
));
$pdf->Ln(6);
//Newsletter
...
$pdf->SetX(95);
$pdf->Button('print', 20, 8, 'Print', 'Print()', array(
    'textColor' => 'yellow',
    'fillColor' => '#FF5050'
));
