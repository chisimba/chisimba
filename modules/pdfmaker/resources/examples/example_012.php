...
$pdf->Rect(100, 10, 40, 20, "DF", $style4, array(
    220,
    220,
    200
));
$pdf->Rect(145, 10, 40, 20, "D", array(
    "all" => $style3
));
// Curve
...
$pdf->Curve(140, 40, 150, 55, 180, 45, 200, 75, "DF", $style6, array(
    200,
    220,
    200
));
...
$pdf->Ellipse(175, 105, 15, 7.50, 45, 270, 360, "F", $style6, array(
    220,
    200,
    200
));
...
$pdf->RegularPolygon(55, 190, 10, 6, 45, 0, "DF", array(
    $style6,
    0,
    $style7,
    0,
...
$pdf->RegularPolygon(90, 190, 15, 3, 0, 1, "DF", array(
    "all" => $style5
) , array(
    200,
    220,
...
$pdf->RegularPolygon(125, 190, 15, 4, 30, 1, null, array(
    "all" => $style5
) , null, null, $style6);
...
$pdf->StarPolygon(55, 230, 7, 12, 5, 45, 0, "DF", array(
    $style6,
    0,
    $style7,
    0,
...
$pdf->StarPolygon(90, 230, 15, 20, 6, 0, 1, "DF", array(
    "all" => $style5
) , array(
    220,
    220,
...
$pdf->StarPolygon(125, 230, 15, 5, 2, 30, 1, null, array(
    "all" => $style5
) , null, null, $style6);
...
$pdf->RoundedRect(140, 255, 40, 30, 8.0, "0101", "DF", $style6, array(
    200,
    200,
    200
));
