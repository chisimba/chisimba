...
/**
* Parses a SPARQL Query string and returns a Query Object_rap.
*
* @author   Tobias Gauss <tobias.gauss@web.de>
* @author   Christian Weiske <cweiske@cweiske.de>
* @version     $Id: SparqlParser.php 7228 2007-09-27 06:24:51Z kudakwashe $
*
* @package sparql
*/
class SparqlParser extends Object_rap
{

    /**
    * The query Object_rap
    * @var Query
    */
    protected $query;
