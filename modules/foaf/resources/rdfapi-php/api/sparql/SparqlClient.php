...
*
* @version  $Id: SparqlClient.php 7228 2007-09-27 06:24:51Z kudakwashe $
* @author   Tobias Gauß <tobias.gauss@web.de>
*
* @package sparql
*/

class SparqlClient extends Object_rap {
	...
	*
	* @param ClientQuery  $query   the ClientQuery Object_rap.
	*/
