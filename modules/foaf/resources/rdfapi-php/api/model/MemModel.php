...
*
*
* @version  $Id: MemModel.php 7228 2007-09-27 06:24:51Z kudakwashe $
...
class MemModel extends Model {
	...
	*
	* @param    String            $pos
	* @param    Object_rap Subject    &$subject
	* @param    Object_rap Predicate  &$predicate
	* @param    Object_rap Object_rap	 &$object
	* @param    int				 &ind
	* @return   MemModel          $res
	* @access   private
	*/
