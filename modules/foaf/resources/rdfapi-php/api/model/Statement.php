 ...
 * @version  $Id: Statement.php 7228 2007-09-27 06:24:51Z kudakwashe $
 * @package model
 */
class Statement extends Object_rap {
  ...
  function & reify(&$model_or_bNodeID) {
		...
		$statementModel->add(new Statement($thisStatement, $RDFobject, $this->Object_rap()));
