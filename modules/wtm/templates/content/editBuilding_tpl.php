...
/**
*
* WTM edit building template
*
* This file provides a means to display the WTM module's edit/add form
* 
* PHP version 5
*
...
//Add description on left column
$cssLayout->setLeftColumnContent("Add/Edit Building");
//Instantiate editbuilding object
$objEdit = $this->getObject('editbuilding', 'wtm');
//Add the form to the middle (right in two column layout) area
$cssLayout->setMiddleColumnContent($objEdit->show());
echo $cssLayout->show();
?>
