...
/**
*
* WTM edit event template
*
* This file provides a means to display the WTM module's edit/add form for events
* 
* PHP version 5
*
...
$cssLayout->setLeftColumnContent("Add/Edit Event");
//Instantiate editevent object
$objEditEvent = $this->getObject('editevent', 'wtm');
//Add the form to the middle (right in two column layout) area
$cssLayout->setMiddleColumnContent($objEditEvent->show());
echo $cssLayout->show();
?>
