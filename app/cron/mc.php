<?php
/**
* Script to alter all tables in a database to support mirroring 
* 
* Author Paul Scott
* USAGE INSTRUCTIONS:
...
*/
       ...
       //{
               ...
               $tables = mysql_query("SHOW TABLES") or die('No tables could be found in database: $row[0]');

               //For each table.....
               while ($table = mysql_fetch_row($tables))
               {
                  //Alter the type to UTF-8 regardless of what type it was before.
                       $result = mysql_query("ALTER TABLE $table[0] ADD `updated` TIMESTAMP( 14 ) NOT NULL DEFAULT 'NOW()'; "); //or die(mysql_error());
