...
/**
 * 
 * DOM-based replacement for HTMLelements.
 * 
 * DOM-based replacement for HTMLelements to improve the loading speed and compatibility with improvements to HTML since the last ice age when HTMLelements was created.
 * 
 * PHP version 5
 * 
 ...
 * @category  Chisimba
 * @package   helloforms
 * @author    Luci Carosin luci.carosin@wits.ac.za
...
/**
* 
* Controller class for Chisimba for the module htmldom
*
* @author Luci Carosin
* @package htmldom
*
...
class htmldom extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the htmldom controller
    * @access public
    * 
    */
    public function init()
    {
        ...
        $this->objDbhtmldom = & $this->getObject('dbhtmldom', 'htmldom');
    ...
    /**
     * 
     * The standard dispatch method for the htmldom module.
