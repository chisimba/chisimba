...
abstract class lucenesearchsimilarity
{
    /**
     * The Similarity implementation used by default.
     *
     * @var search_Similarity
     */
     ...
     */
    static public function setDefault(lucenesearchsimilarity $similarity)
    {
     ...
     * code.
     *
     * @return search_Similarity
     */
    static public function getDefault()
    {
        if (!self::$_defaultImpl instanceof lucenesearchsimilarity) {
            self::$_defaultImpl = new lucenesearchsimilarity_Default();
        }
