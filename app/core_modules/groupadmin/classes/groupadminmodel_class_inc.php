...
class groupAdminModel extends dbTable
{
    ...
    */
    ...
    /**
    * @var groupuserDb $_objGroupUsers an association to the groupuserDb object.
    */
    var $_objGroupUsers;
...
/////////////////////////////////////////////////////////////////////
    ...
    */
    function addGroup( $name,  $description, $parentId = null )
    {
        // CIRCULAR References:
    ...
    */
    function getGroups( $fields = array( "id", "name" ), $filter = null )
    {
    ...
    */
    function getGroupsToRoot( $groupId )
    {
        $toRoot = array();
    ...
    * @return true|false true if successful, otherwise false.
    */
    function setDescription( $groupId, $newDescription )
    {
        $updates = array();
    ...
    * @return true|false true if successful, otherwise false.
    */
    function setName( $groupId, $newName )
    {
        $updates = array();
...
//////////////////////////////////////////////////////////////////////
    ...
    */
    function _getGroupPath( $curNode, &$path, &$leaf )
    {
    ...
    */
    function _getGroupsToRoot( $curNode, &$toRoot )
    {
    ...
    * @param array the array containing all the nodes found.
    */
    function _getSubgroups( $curNode, &$subgroups )
    {
        $result = $this->getChildren( $curNode );
