...
class FCKeditor
{
	...
	function __construct( $instanceName, $siteRoot, $context = 'No' )
 	{
		$this->InstanceName	= $instanceName ;
		$this->SiteRoot     = $siteRoot;
        $this->Context      = $context;
		$this->BasePath		= $this->SiteRoot.'/modules/htmlelements/resources/FCKeditor/' ;
		$this->Width		= '100%' ;
		$this->Height		= '200' ;
	...
	// PHP 4 Contructor
	function FCKeditor( $instanceName, $siteRoot, $context = 'No' )
	{
		$this->__construct( $instanceName, $siteRoot, $context ) ;
	}
	...
	function CreateHtml()
	{
        $HtmlValue = htmlspecialchars(stripslashes($this->Value)) ;
