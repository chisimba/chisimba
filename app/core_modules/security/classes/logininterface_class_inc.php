    ...
    */
    public function renderLoginBox($module = NULL)
    {
    	try {
    		...
    		$objForm->addRule('username',$this->objLanguage->languageText("mod_login_unrequired", 'system', 'Please enter a username. A username is required in order to login.'),'required');
