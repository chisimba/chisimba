...
<?
    ...
    $row=array($objLanguage->languageText("step1"), str_replace("[--INSTITUTIONNAME--]",$this->objConfig->institutionShortName(),$objLanguage->languageText("heading_ifyouatinstitute")), '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', str_replace("[--INSTITUTIONNAME--]",$this->objConfig->institutionShortName(),$objLanguage->languageText("heading_ifguest")));
