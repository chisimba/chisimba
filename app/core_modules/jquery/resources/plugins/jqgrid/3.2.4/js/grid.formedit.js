    ...
    delGridRow : function(rowids,p) {
        ...
        return this.each(function(){
            ...
            //} else {
                ...
                //author Charl Mert : Removed the modal window (Now using jqBoxy instead - facebook styled)
                addPostData(IDs,tbl,p,$t.grid.hDiv,$t.grid.hDiv);
...
function addPostData(aIDs, content, p, insertSelector, posSelector, appendsel) {

    var clicon = p.imgpath ? p.imgpath+'/'+p.closeicon : p.closeicon;
    var mw  = document.createElement('div');
    jQuery(mw).addClass("postdata").attr("id",aIDs.themodal);
    //var mh = jQuery('<div id="'+aIDs.modalhead+'"><table width="100%"><tbody></tbody></table> </div>');
    var mc = document.createElement('div');
    jQuery(mc).addClass("postcontent").attr("id",aIDs.modalcontent);
    jQuery(mc).append(content);
    mw.appendChild(mc);
    var loading = document.createElement("div");
    jQuery(loading).html("<div class=\"loading\"><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"boxy-wrapper fixed\" style=\"z-index: 1338; visibility: visible; opacity: 1;\">    <tbody>        <tr>            <td class=\"top-left\"/>            <td class=\"top\"/>            <td class=\"top-right\"/>        </tr>        <tr>            <td class=\"left\"/>            <td class=\"boxy-inner\">         <table>                        <tr>                            <td align=\"center\"><span style=\"font-size:0.9em;\">"+p.processData+"</span> <img src=\"core_modules/htmlelements/resources/jquery/plugins/jqgrid/3.2.4/themes/shorturl/images/loader_small.gif\"/></td>                        </tr>                    </table>                </p>            </td>                <td class=\"right\"/>        </tr>        <tr>            <td class=\"bottom-left\"/>            <td class=\"bottom\"/>            <td class=\"bottom-right\"/>        </tr>    </tbody></table></div>"||"");
    jQuery(mw).prepend(loading);
    //jQuery(mw).prepend(mh);
    jQuery(mw).addClass("postdata");
