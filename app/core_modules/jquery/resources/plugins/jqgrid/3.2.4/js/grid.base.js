...
$.fn.jqGrid = function( p ) {
    ...
    //Charl Mert
    $.fn.showProcessing = function() {

        var $t = this[0];
        if (!$t.grid) {return;}

        var loader = document.createElement("div");
        $(loader).html("<div><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"boxy-wrapper fixed\" style=\"z-index: 1338; visibility: visible; opacity: 1;\">    <tbody>        <tr>            <td class=\"top-left\"/>            <td class=\"top\"/>            <td class=\"top-right\"/>        </tr>        <tr>            <td class=\"left\"/>            <td class=\"boxy-inner\">         <table>                        <tr>                            <td align=\"center\"><span style=\"font-size:0.9em;\">" + $(this).getGridParam('processText') + "</span> <img src=\"core_modules/htmlelements/resources/jquery/plugins/jqgrid/3.2.4/themes/shorturl/images/loader_small.gif\"/></td>                        </tr>                    </table>                </p>            </td>                <td class=\"right\"/>        </tr>        <tr>            <td class=\"bottom-left\"/>            <td class=\"bottom\"/>            <td class=\"bottom-right\"/>        </tr>    </tbody></table></div>"||"");
        $(loader).addClass('loading');
        $(loader).show();
        $($t.grid.hDiv).append(loader);
    ...
    $.fn.showLoading = function() {
        ...
        var loader = document.createElement("div");
        $(loader).html("<div><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"boxy-wrapper fixed\" style=\"z-index: 1338; visibility: visible; opacity: 1;\">    <tbody>        <tr>            <td class=\"top-left\"/>            <td class=\"top\"/>            <td class=\"top-right\"/>        </tr>        <tr>            <td class=\"left\"/>            <td class=\"boxy-inner\">         <table>                        <tr>                            <td align=\"center\"><span style=\"font-size:0.9em;\">" + $(this).getGridParam('loadtext') + "</span> <img src=\"core_modules/htmlelements/resources/jquery/plugins/jqgrid/3.2.4/themes/shorturl/images/loader_small.gif\"/></td>                        </tr>                    </table>                </p>            </td>                <td class=\"right\"/>        </tr>        <tr>            <td class=\"bottom-left\"/>            <td class=\"bottom\"/>            <td class=\"bottom-right\"/>        </tr>    </tbody></table></div>"||"");
        $(loader).addClass('loading');
        $(loader).show();
        $($t.grid.hDiv).append(loader);
	...
	return this.each( function() {
		...
		$(grid.hDiv)
			//.css({ width: grid.width+"px", overflow: "block"})
			//.prepend('<div class="loading"><div class="loaderimage"></div>'+ts.p.loadtext+'</div>')
            .prepend("<div class=\"loading\"><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" class=\"boxy-wrapper fixed\" style=\"z-index: 1338; visibility: visible; opacity: 1;\">    <tbody>        <tr>            <td class=\"top-left\"/>            <td class=\"top\"/>            <td class=\"top-right\"/>        </tr>        <tr>            <td class=\"left\"/>            <td class=\"boxy-inner\">         <table>                        <tr>                            <td align=\"center\"><span style=\"font-size:0.9em;\">"+ts.p.loadtext+"</span> <img src=\"core_modules/htmlelements/resources/jquery/plugins/jqgrid/3.2.4/themes/shorturl/images/loader_small.gif\"/></td>                        </tr>                    </table>                </p>            </td>                <td class=\"right\"/>        </tr>        <tr>            <td class=\"bottom-left\"/>            <td class=\"bottom\"/>            <td class=\"bottom-right\"/>        </tr>    </tbody></table></div>")
			.append(grid.hTable)
