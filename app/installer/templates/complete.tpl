...
<p>
<!--<a href="#template_bottom">here</a>--><!--javascript: -->Perform alternate AJAX final setup and log in to system <input id="finish_button" type="image" onmouseover="over('finish', this)" onmouseout="off('finish', this)" src="<?php echo $extra ?>/finish_off.png" name="finish" value="Finish" onclick="ajax_install('<?php echo $ajaxregister_url ?>', '<?php echo $ajaxregister_url_params ?>', '<?php echo $ajaxlogin_url ?>'); return false;">
</p>
